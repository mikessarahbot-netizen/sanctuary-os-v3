...
/**
 * Runtime configuration for the desktop Presenter replay sidecar, parsed from an
 ...
 */
const ENV_KEYS = {
  actorId: "SANCTUARY_OS_PRESENTER_ACTOR_ID",
  actorRoles: "SANCTUARY_OS_PRESENTER_ACTOR_ROLES",
  authToken: "SANCTUARY_OS_PRESENTER_AUTH_TOKEN",
  backoffBaseSeconds: "SANCTUARY_OS_PRESENTER_REPLAY_BACKOFF_BASE_SECONDS",
  backoffCapSeconds: "SANCTUARY_OS_PRESENTER_REPLAY_BACKOFF_CAP_SECONDS",
  backoffMultiplier: "SANCTUARY_OS_PRESENTER_REPLAY_BACKOFF_MULTIPLIER",
  graphqlEndpoint: "SANCTUARY_OS_PRESENTER_GRAPHQL_ENDPOINT",
  intervalMs: "SANCTUARY_OS_PRESENTER_REPLAY_INTERVAL_MS",
  maxAttempts: "SANCTUARY_OS_PRESENTER_REPLAY_MAX_ATTEMPTS",
  requestIdHeaderName: "SANCTUARY_OS_PRESENTER_REQUEST_ID_HEADER",
  sqliteFilePath: "SANCTUARY_OS_PRESENTER_SQLITE_PATH",
  tenantId: "SANCTUARY_OS_PRESENTER_TENANT_ID"
} as const;

export interface PresenterDesktopReplayPolicyConfig {
...
export interface PresenterDesktopSidecarConfig {
  readonly actor: AuthenticatedActor;
  readonly authToken: string;
  readonly graphqlEndpoint: string;
  readonly intervalMs: number;
  readonly policy: PresenterDesktopReplayPolicyConfig;
...
export const parsePresenterDesktopSidecarConfig = (
  env: Readonly<Record<string, string | undefined>>
): PresenterDesktopSidecarConfig => {
