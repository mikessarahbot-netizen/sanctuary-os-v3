...
/**
 * The Play local sync queue is backed by SQLite on the offline-first desktop
...
const baseEntry: PlayLocalSyncQueueEntryPersistenceRecord = {
  ...
  operation: {
    ...
    payload: {
      activeSectionRef: "section_live_1",
      clickEnabled: true,
      positionBeats: 4,
      tenantId,
      trackSetId: "track_set_live_1",
...
describe("Play local sync queue SQLite integration smoke", () => {
